...
const PdfPageNavigator = ({ 
  ...
  // ========================================================================
  //  FIX #1: Implement robust retry logic for API calls to handle 429 errors.
  // ========================================================================
  ...
  // ========================================================================
  //  FIX #2: Make the "Analyze All" function more resilient to errors.
  // ========================================================================
  ...
  useEffect(() => {
    // ========================================================================
    //  FIX #3: Correctly analyze the *current* page on load, not just page 1.
    // ========================================================================
  ...
  return (
    // The entire JSX section remains unchanged.
